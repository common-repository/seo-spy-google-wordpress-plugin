...
function seowatcher_supportlink() {
	echo "<a href=\"http://www.laliamos.com\" alt=\"Posicionamiento web SEO\">Posicionamiento web SEO</a>\n";
}
...
<form name="form1" method="post" action="<?=$location ?>">
	<div id="keyworddiv" class="postbox" style="max-width:700px;""><h3 class="hndle"><span><?php _e('Actualizar ahora!', 'seowatcher'); ?></span></h3>
	<div class="inside">
...
function seowatcher_option_page_content() {
	...
	<?=$seocMessage; ?>
	<br>
	<div id="keyworddiv" class="postbox" style="max-width:700px;"><h3 class="hndle"><span><?php _e('Palabras clave', 'seowatcher'); ?></span></h3>
	<div class="inside">
	...
	<?php _e('(Palabras múltiples claves separadas por comas.) </p><p>Cada una de estas palabras clave será leída por cada URL única, por lo que se puede comparar el ranking de Google con otros sitios web.</p><p><b>Se pueden definir como máximo 3 palabras clave.</b></p>', 'seowatcher'); ?>
	</div>
	</div>
	...
	<?php _e('(URLs separadas por comas.)</p><p> La URL tiene que ser introducido por el patrón o subdomain.domain.com domain.com.</p><p><b>Se pueden definir como máximo 3 URLs.</b></p>', 'seowatcher'); ?>
	</div>
	</div>
	...
	<?php _e('Seo Spy le ayuda a realizar un seguimiento de su posicionamiento en Google.', 'seowatcher'); ?>
	<br> <?php _e('En el <b>Escritorio</b> encontrará las estadísticas diarias actuales y el botón para actualizar.', 'seowatcher'); ?>
	</div>
	</div>
	
	<div id="submitdiv" class="postbox"><h3 class="hndle"><span><?php _e('Donar!!', 'seowatcher'); ?></span></h3>
	<div class="inside" style="padding:5px;">
	<?php _e('Mucho trabajo se ha puesto en el desarrollo de la Seo Spy.<br> Si usted quiere asegurarse de que la Vigía Seo queda libre, por favor considere hacer una donación.<br>', 'seowatcher'); ?>
	<br>
